...
public class ProductController implements ActionListener {
    ...
    private void saveProduct() {
        int productID;
        try {
            productID = Integer.parseInt(productView.getTxtProductID().getText());  //saves the product
        }
        ...
        double productPrice;
        try {
            productPrice = Double.parseDouble(productView.getTxtProductPrice().getText());  //shows the product price
        }
        catch (NumberFormatException e) {
        ...
        try {
            productQuantity = Double.parseDouble(productView.getTxtProductQuantity().getText()); //shows the number of the specific product
        }
        catch (NumberFormatException e) {
        ...
        String productName = productView.getTxtProductName().getText().trim(); //shows the products name

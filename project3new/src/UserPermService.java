...
public class UserPermService {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting User Permissions service at port = " + port);
    ...
    private static void serve(Socket socket, int clientID) throws Exception {
        ...
        if (model == null) {
            ...
            User dummy = adapter.loadUser(username);
            ans = gson.toJson(dummy);
            printer.writeUTF(ans);
            printer.flush();
    ...
    private static boolean register(String regHost, int regPort, String myHost, int myPort) throws IOException {
        ...
        info.serviceCode = ServiceInfoModel.USER_PERMS_SERVICE;
